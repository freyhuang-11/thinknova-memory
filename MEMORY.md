...
- 🔴🔴 [项目:故事板跟随性/裁格测试盘子](project_thinknova_storyboard_test.md) — **当前主线**;四问(黑屏挡网格/要不要裁格/跟随性≥70%/omni一致性)+每题2轮;含**我能自己烧单的UI驱动法+查证接口**;实拉发现53条案例「口播出镜+5镜头」自相矛盾必废故事板、63条缺预设、默认16:9横屏
