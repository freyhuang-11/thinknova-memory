...
- 🔴 [Reference: 多参考图i2v模型](reference_thinknova_multiref_model.md) — 单参只喂截格/多参才把参考图给i2v;468配置(maxReferenceImages+reference_images字段+多图≤10s);图生图产品没锁根治=多参i2v(与口播锁人物同根)
