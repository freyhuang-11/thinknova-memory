...
- **当前配方=E13版(母版候选,已在线上;等用户确认后连跑3-4条稳定性)**:较E11的关键升级=①每格画成9:16竖长方形(左右留白)——板与视频比例同构;生成商无视size参数出方图=P0技术项 ②**台词全改旁白(画外音)**:店主第一人称探店vlog口吻,人物专注做事不对口型(grok对不上口型;📌seedance 15s可对口型,上新后切出口对白模式) ③禁『私信/关注/点赞/下单』平台词,引导只许软性到店 ④三句主题铁律:格1做什么/格2好在哪(都不许提价)/格3价格+软邀请(价格全片只出现一次)——E13旁白"今天给姐妹做日式美甲呀/她们做完都说自然又显白哦/新客体验价九十九,喜欢来店里试试吧"满分。
