...
- **当前配方=E11版(新基线,已在线上)**:①2×2四格板、**每格自己画成9:16竖幅构图**(生成商无视size参数一律出1254方图=比例问题根源,已提示词层自救,根治进技术清单) ②**全片无字幕无任何文字**(用户拍板) ③**板面唯一文字=三行『台词』**——关键机理:grok口播=朗读首帧图里所有像素文字,写什么念什么;E10把机位标注也念了→E11删光参数标注,镜头意图全靠画面构图表达 ④**台词必须人话**(完整口语句+语气词"呀啦吧",给例句锚定;禁广告压缩短语)——E11口播"新客体验九十九呀!现在预约还挺划算的啦/喜欢就私信我约起来吧",说满10秒含CTA ⑤中文数字一律汉字 ⑥拟态肤质(毛孔/T区油光/雀斑痣/唇纹/碎发,iPhone直出零磨皮)——AI模特脸彻底消失 ⑦四拍:钩子/过程/价值/收尾微笑(格4无台词) ⑧手持感+甩镜遮挡转场。
