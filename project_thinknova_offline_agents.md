...
- **当前配方=E17版(母版候选v4,已在线上)**:E13三格竖排板+产品7人物3(格1产品特写/格2人物专注操作/格3成品+浅笑)+表情眼神工程(禁呆滞空洞面具脸)+手部铁律(五指自查+7个新负面词)+i2v规则清单式三节(情绪/眼神/表演,汉化自用户黄金参考——同模型咖啡店闺蜜UGC提示词,证明grok能有情绪表演)+旁白情绪曲线(轻赞叹→认可→真心推荐,重音停顿)。E17成片仅剩4.5s一秒溶解鬼手(grok转场方差);等用户听口播定情绪→定母版→4条稳定性统计(转场干净率/手部完好率/顺序正确率/口播完整率)。黄金参考范式:规则清单短句+分节+角色肤质参考表(参考图3槽上线后可用)。
