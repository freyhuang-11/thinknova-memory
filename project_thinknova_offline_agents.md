...
- **当前配方=E9版(已在线上)**:三格竖排板/手持质感/甩镜+遮挡转场(硬切grok做不到)/三句台词分工(格1商品钩子·格2价格·格3行动,互不重复禁加店名)/**中文数字一律汉字**(99必念错,九十九才对;英文无此问题)/每格【语气】标注(兴奋/真诚…情绪曲线)+说话方式分自然口语vs对镜头对白/**真人感规则**(真实肤质毛孔不磨皮/素人店员/禁网红滤镜——E9实测AI模特脸消失,UGC质感)/字幕唯一。
- **头号残留=口播完整率**(第三句缺失,4轮1/4,模型方差);老案例sceneIds为空bug已修(7条挂S02+补选项)。E1-E9共约315积分。
