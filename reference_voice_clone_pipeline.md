...
metadata: 
  ...
  modified: 2026-07-31T07:49:22.643Z
---
...
## 🔴🔴 写稿铁律:多音字一律绕开(07-31 老板定)
**AI合成音读不准多音字,发现一个换一个,别赌**。老板原话:「我们是ai生成的音频,所以多音字不能要,比如说说服自己,要改为告诉自己」。
- 已踩:**说服**(shuō/shuì)→改「告诉」;**照着**(zhe/zháo)→改「按」;**补上下面**(断句歧义,会读成"补/上下/面")→改「把下面这层补齐」。
- 写完稿扫一遍高频雷:说服/差/长/重/行/少/得/地/为/blocked、还、朝、藏、convey、数、分、种、发、切、произ、当、结、系、露、削、模、量、称、供、扇、缝、宁、都、乐、传、剥、载、率、给、假、间、强、卡、空、累、脉、弹、觉、склад、звук。**拿不准=换词**,不要指望参数能纠。
- 合成后必用 flash ASR 回听转写核对:ASR转写和原稿不一致的地方=读错了或断句错了,原地改词重合成。
