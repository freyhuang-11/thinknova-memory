...
## 📝 待审(都写好了,等老板一句话)
- **小红书第2批 5 篇 · v4 方向已定稿,正文未展开**:老板否掉 v3(五篇太像)。**新的五个入口**:①顾客问了三次「有啥新的」②今年上了多少新品发了几条 ③第一条做完我不敢发 ④「我们这行不适合做视频」⑤换季清仓这周开始内容跟上了吗。落点仍是「只说两句话」。**他确认入口够散,我再展开正文+配图清单**。文件 `对外推介/营销视频_导演台/小红书_第2批5篇_待审_2026-08-01.md`(里面还是 v3,要按 v4 重写)。
  🔴 **配图零成本方案**:01/02 直接抽 G1/G2/G3 三条成片的帧,那本身就是「两句话出的视频」的证据。
